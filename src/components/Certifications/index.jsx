...
const certifications = [
  { id: 1, name: 'Artificial Intelligence Fundamentals', path: '/Artificial Intelligence Fundamentals.png' },
  { id: 2, name: 'Deepening the capabilities of Artificial Intelligence', path: '/Deepening the capabilities of Artificial Intelligence.png' },
  { id: 3, name: 'GoIT FullStack Developer', path: '/GoIT FullStack Developer.png' },
  { id: 4, name: 'HackFrost Winter Hackathon', path: '/HackFrost Winter Hackathon.png' },
  { id: 5, name: 'Hugging face', path: '/Hugging face.png' },
  { id: 6, name: 'Kharkiv IT Cluster Certificate', path: '/Kharkiv IT Cluster Certificate.png' },
  { id: 7, name: 'Mashine Learning Tech Taster', path: '/Mashine Learning Tech Taster.png' },
